...
- 🐛 Automatic GitHub Issues on downtime
- 🌐 Public status page via GitHub Pages
...
- **GitHub Actions** run uptime checks every 5 minutes
- Results are stored as commits in this repo
- Downtime automatically opens GitHub Issues
